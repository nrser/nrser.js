...
module.exports = function(options) {
  ...
  function addTask() {
    tasks.push(Array.from(arguments));
  }
  ...
  */
  addTask('clean', _.map(buildDirs, bd => 'clean:' + bd.name));
  ...
  * compile all sources.
  */
  addTask('build', _.map(buildDirs, bd => 'build:' + bd.name));
  ...
  */
  addTask('test:watch', ['build:then:test'], () => {
